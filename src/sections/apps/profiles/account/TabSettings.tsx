...
// material-ui
import { Alert, Button, Checkbox, Divider, Grid, List, ListItem, ListItemText, Stack, Switch, Typography } from '@mui/material';

// project import
import MainCard from 'components/MainCard';
import WeekDaysDialog from 'pages/dashboard/setWeekDay';
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Alert severity="error" sx={{ mb: 1 }}>
        Set Your All Week Days Timing of Your Branch &nbsp;&nbsp;&nbsp;&nbsp;
        <Button
          sx={{ backgroundColor: 'blue', color: 'white', '&:hover': { backgroundColor: 'blue', color: 'white' } }}
          onClick={handleDialogOpen}
        >
          Set
        </Button>
      </Alert>
      <WeekDaysDialog open={dialogOpen} onClose={handleDialogClose} onSubmit={handleFormSubmit} />
