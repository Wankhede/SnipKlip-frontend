...
export let events: EventInput[] = [
  ...
  },
  {
    ...
    start: add(new Date(), { hours: 3, minutes: 30 }),
    end: add(new Date(), { hours: 3, minutes: 20 }),
    title: 'Meeting'
  },
  {
    ...
    start: add(new Date(), { hours: 2, minutes: 30 }),
    end: add(new Date(), { hours: 3, minutes: 30 }),
  ...
  },
  {
    ...
    allDay: false,
    description: 'Discuss about the new project',
    start: add(new Date(), { days: 2, hours: 5, minutes: 25 }),
    end: add(new Date(), { days: 2, hours: 5, minutes: 55 }),
    title: 'Send Gift'
  },
  {
    ...
    end: add(new Date(), { days: 2, hours: 5, minutes: 15 }),
