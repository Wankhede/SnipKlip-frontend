...
import { getPersonalDetails } from 'services/salon';
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  <Stack spacing={1.25}>
                    ...
                    <TextField type="email" fullWidth defaultValue="jordan.lee@snipklip.in" id="personal-email" placeholder="Email Address" />
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack spacing={1.25}>
