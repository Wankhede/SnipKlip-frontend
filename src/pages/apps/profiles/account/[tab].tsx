...
import TabAccount from 'sections/apps/profiles/account/TabService';
...
// assets
import { ContainerOutlined, FileTextOutlined, SettingOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const AccountProfile = () => {
  ...
  return (
    <Page title="Salon Profile">
      <MainCard border={false} boxShadow>
        <Box sx={{ borderBottom: 1, borderColor: 'divider', width: '100%' }}>
          <Tabs value={value} onChange={handleChange} variant="scrollable" scrollButtons="auto" aria-label="account profile tab">
            <Tab label="Profile" icon={<UserOutlined />} value="basic" iconPosition="start" />
            <Tab label="My Branch" icon={<TeamOutlined />} value="role" iconPosition="start" />
            <Tab label="Services" icon={<ContainerOutlined />} value="my-account" iconPosition="start" />
