...
const AuthResetPassword = () => {
    ...
    const updateUserPassword = async (values: any) => {
        try {
            // TODO
            const response = await uninterceptedAxiosServices.post(`/api/v3/update-user-password/`, {
            ...
            if (response.data.status) {
                ...
                EssentialMethods.showSnackbar(response.data.error_message.validation_message, errorColor);
            }
