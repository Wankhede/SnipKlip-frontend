            ...
            >
              <CardContent>
                <Grid container alignItems="center" justifyContent="space-between">
                  ...
                  <Grid item>
                    <AnimateButton>
                      <CopyToClipboard text="SNIP50" onCopy={() => setDiscount('SNIP50')}>
                        <Button
                          variant="outlined"
                          color="secondary"
                          size="small"
            ...
            <Grid container spacing={3} alignItems="center">
              ...
              <Grid item xs={12} sm={8}>
                <Stack spacing={0.25}>
                  ...
                  <Typography variant="caption">When you subscribe to the unlimited consultation plan on SnipKlip.</Typography>
                </Stack>
              </Grid>
