...
function CustomTable({ columns, paginationData, getTableRows, addButton, bulkUploadButton, paginateData = true, top, editable = false, rowSelection = true, nonEditableColumns = [], updateTableValues = () => { }, hiddenColumns = [], columnResize = false, filename, searchColumns = [] }: CustomTablePropsI) {
	...
	const { pageIndex, pageSize } = paginationData ? paginationData : { pageIndex: 0, pageSize: 2 }
