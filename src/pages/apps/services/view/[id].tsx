...
function ViewService() {
    ...
    return apiResponse ? <AddService data={apiResponse} accessibility={false} id={id} title="View Form" /> : null
}

ViewService.getLayout = function getLayout(page: ReactElement) {
