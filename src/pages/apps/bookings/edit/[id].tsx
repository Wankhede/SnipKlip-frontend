...
function EditBooking() {
    ...
    return apiResponse ? <AddBookingPlan data={apiResponse} accessibility={true} id={id} title="Edit Booking" /> : null
}

EditBooking.getLayout = function getLayout(page: ReactElement) {
